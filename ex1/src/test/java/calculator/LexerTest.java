...
public class LexerTest {
    ...
    @Test
    public void customIDTest() throws  IOException {
        String input = "Hg1_f p_1";
        assertEquals("ID(Hg1_f), ID(p_1)", printTokens(input));
    }
    @Test
    public void customKeywordTest() throws  IOException {
        String input = "if iff";
    ...
    @Test
    public void customLineComment() throws  IOException {
        String input = "3 + 4 -- this is == + if _  -a comment\n == 7";
        assertEquals("NUMBER(3), PLUS, NUMBER(4), EQUALS, NUMBER(7)", printTokens(input));
    }
    @Test
